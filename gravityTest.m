classdef gravityTest < matlab.unittest.TestCase
  ...
  methods(Test)
    ...
    function testCase=sh2grid(testCase)
      ...
      test='gravity.sh2grid_multiple';
      %call the routine to be tested
      gravity.sh2grid(...
        fullfile(utilsTest.dirin(test),'GSWARM_GF_SABC_COMBINED_2020-1*_09.gfc'),...
        'static',            'ggm05c',...
        'smoothing_radius',     750e3,...
        'functional',          'eqwh',...
        'spatial_step',             2 ...
      );
      %need to move the resulting files to the test directory
      file.ensuredir(utilsTest.dircheck(test),false)
      file.system(['mv -fv ',...
        fullfile(utilsTest.dirin(test),'GSWARM_GF_SABC_COMBINED_2020-1*_09.*.xyz'),' ',...
      ...
      %define the test name
      test='gravity.sh2grid_single';
      %call the routine to be tested
      gravity.sh2grid(...
        './test/in/gravity.sh2grid_single/GSWARM_GF_SABC_COMBINED_2020-01_09.gfc',...
        'static',            'ggm05c',...
        'smoothing_radius',     750e3,...
        'functional',          'eqwh',...
        'spatial_step',             2 ...
      ...
      file.ensuredir(utilsTest.dircheck(test),false)
      file.system(['mv -fv ',...
        fullfile(utilsTest.dirin(test),'GSWARM_GF_SABC_COMBINED_2020-01_09.*.xyz'),' ',...
        utilsTest.dircheck(test)],...
        'stop_if_error',true,...
        'disp',true...
      );
