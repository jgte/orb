classdef gravityTest < matlab.unittest.TestCase
  ...
  methods(Test)
    ...
    function testCase=grace(testCase)
      test='gravity.grace';
      a=gravity.grace(...
        'start',datetime('2008-01-01'),...
        'stop' ,datetime('2008-12-31'),...
        'download_data',false ...
      );
      %check if test passes
      testCase=utilsTest.check_test_data(testCase,test,a);
    end
    function testCase=pardecomp(testCase)
      test='gravity.pardecompt';
      [d,datafile]=gravity.grace(...
        'lmax',20,...
        'start',datetime('2008-01-01'),...
        'stop' ,datetime('2010-12-31'),...
        'download_data',false ...
      );
      [g,pd_set]=d.pardecomp(...
        'force',true,...
        'parallel',true,...
        'datafile',strrep(datafile,'grace.','grace-model.'),...
        'epoch',datetime('2008-01-01'),...
        'timescale','years',...
        'T',[1,0.5],...
        'np',2 ...
      );
      %check if test passes
      testCase=utilsTest.check_test_data(testCase,test,struct('d',d,'g',g,'pd_set',pd_set));
    end
  end
end