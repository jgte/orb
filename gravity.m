...
%       end
    ...
    function out=grace_data_dir(varargin)
    ...
    function out=grace(varargin)
      ...
      %shortcuts
      data_dir=gravity.GRACE_data_dir(varargin{:});
      RL=gravity.translate_GRACE_release(v.release);
      ...
      if v.download_data
        ...
        file.system(...
          ['./download-l2.sh ',v.center,' ',str.clean(RL,'RL')],...
          'disp',true,...
      ...
      no_name_parameters={'center','release','download_data','force'};
      if v.start==time.zero_date
      ...
      v1=v;
      mat_filename=fullfile(data_dir,['GRACE.',v1.name(no_name_parameters),'.mat']);
      clear v1
