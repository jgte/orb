...
%       legend('o1 original','o2 original','o1 interp','o2 interp')
    ...
    function f=component_split_fileroot(obj,dir,ext,search,lower_durat,upper_durat,nr_seg,t_extrapolate,t_crop,aperiodic_order)
      ...
      f=fullfile(dir,[...;
        str.show({...
          obj.descriptor,...
          str.show({'search',            search         },'join_char',          '_'),...
          strrep(str.show({'lower_durat',lower_durat    },'join_char',          '_'),' ',''),...
          strrep(str.show({'upper_durat',upper_durat    },'join_char',          '_'),' ',''),...
          str.show({'nr_seg',            nr_seg         },'join_char',          '_'),...
          str.show({'t_extrapolate',     t_extrapolate  },'fmt',yyyy-mm-dd','join_char','_'),...
          str.show({'t_crop',            t_crop         },'fmt',yyyy-mm-dd','join_char','_'),...
          str.show({'aperiodic_order',   aperiodic_order},'join_char',          '_'),...
