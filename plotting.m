classdef plotting
  properties(Constant)
    ...
    default={...
     ...
     'plot_legend_align_scale_bias',false,@(i) islogical(i) || ischar(i);... %this is done after plot_legend_align, destroying it
     'plot_scale_legend_str',' x ',       @(i) ischar(i);...
      'plot_legend_align_str', {},        @(i) iscellstr(i);...
'plot_legend_align_right_just',true,      @(i) islogical(i) || ischar(i);...
        'plot_legend_box',   true,        @(i) islogical(i) || ischar(i);...
        'plot_ylabel',         '',        @(i) ischar(i);...
        'plot_xlabel',         '',        @(i) ischar(i);...
        'plot_xdate',          false,     @(i) islogical(i) || ischar(i);...
        ...
        'plot_visible',         true,     @(i) islogical(i) || ischar(i);...
        ...
        'plot_grid',            true,     @(i) islogical(i) || ischar(i);...
        ...
        'plot_psd',         false,        @(i) islogical(i) || ischar(i);...
        'plot_autoscale',   false,        @(i) islogical(i) || ischar(i);... %y-scale is derived from the data (in plotting.enforce)
        'plot_autoscale_factor',4,        @(i) isnumeric(i) && isscalar(i); ...
        'plot_automean',    false,        @(i) islogical(i) || ischar(i);... %middle-point of y axis is derived from the data (in plotting.enforce)
        'plot_zeromean',    false,        @(i) islogical(i) || ischar(i);... %mean of data is removed before plotting (in simpledata.plot)
        'plot_outlier',         0,        @(i) isnumeric(i) && isscalar(i); ...
        'plot_caxis',  [-inf,inf],        @(i) isnumeric(i) && numel(i)==2;...
        'plot_logy',        false,        @(i) islogical(i) || ischar(i);... 
        'plot_logx',        false,        @(i) islogical(i) || ischar(i);... 
        'plot_pause_on_save',false,       @(i) islogical(i) || ischar(i);... 
        'plot_save_fig',     false,       @(i) islogical(i) || ischar(i);... 
        'plot_save_mkdir',    true,       @(i) islogical(i) || ischar(i);... 
        'plot_save_ext',     'png',       @(i) ischar(i);... 
        'plot_dir',file.orbsdir('plot'),  @ischar;...
    };
  end
  methods(Static)
    %% primitives
