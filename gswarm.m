...
%       c20opt='GSFC-7day';
      ...
      v=varargs.wrap('sources',{....
        {...
          ...
          'force',                   false, @islogical;...
          'plot_force',              true, @islogical;... %this will also force reloading the plot data
          'products',{...
            'swarm.sh.gswarm.rl01.smooth750';...  %fig 9
            'swarm.sh.gswarm.rl01.smooth1500';... %fig 10
            'swarm.sh.gswarm.rl01.smooth0';...
...
%         version_list={'GSFC-7day','GSFC','TN-14','TN-11','TN-07'};
      ...
      case 'C20-GSFCvsTN11m' 
        %TODO
%         gswarm.paper('products',{'swarm.sh.gswarm.rl01.smooth750','swarm.sh.gswarm.rl01.smooth750.tn11m'})
