...
% 'swarm.sh.gswarm.rl01.tropical';... used in the rebuttal to reviewer 1
      ...
      case {'gauss-land','spline-land','trunc-land'}
        out=cellfun(@(i) gswarm.paper(varargin{:},'type',i),{...
          [v.type,'0300'];...
          [v.type,'0750'];...
          [v.type,'1500'];...
      ...
      case {'gauss-ocean','spline-ocean','trunc-ocean'}
        out=cellfun(@(i) gswarm.paper(varargin{:},'type',i),{...
          [v.type,'0750'];...
          [v.type,'1500'];...
          [v.type,'3000'];...
...
%         version_list={'GSFC-7day','GSFC','TN-14','TN-11','TN-07'};
      ...
      case 'tropics'              %checking only
        plotfilename=fullfile(v.figures_dir,'checks','cumdas.ts.tropical.vs.non-tropical.png');
        if ~file.exist(plotfilename)
          functional='eqwh';
          out=gswarm.paper(...
            'type','process',...
