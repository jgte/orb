...
% 'swarm.sh.gswarm.rl01.tropical';... used in the rebuttal to reviewer 1
      ...
      case ''
        ...
        for i=1:numel(v.products)
          out=out.init(v.products{i},dirs{:},...
            'force',v.force,...
...
%         version_list={'GSFC-7day','GSFC','TN-14','TN-11','TN-07'};
      ...
      %NOTICE: the flag force will recompute parametric decomposition even if never_force is true
      case 'pd' 
        dirs=gswarm.paper('type','dirs');
        out=datastorage(...
          'start',datetime('2002-04-01'),...
        ...
        for i=1:numel(p)
          out=out.init(p{i},dirs{:},'force',true);
        end
      case 'pd-plot'
        de=[2,3];
        or=[0,0];
      ...
      case 'smooth750'
        ...
        out=out.init('swarm.sh.gswarm.rl01.smooth750',dirs{:},...
          'force',v.force,...
      ...
      case 'tropics'
        ...
        for i=1:numel(tropic_products)
          out=out.init(tropic_products{i},dirs{:},...
            'force',v.force,...
            v.subset('plot').varargin{:}...
          );
        end
